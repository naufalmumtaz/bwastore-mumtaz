...
class DashboardProductController extends Controller
{
    ...
    public function detail(Request $request, $id) {
        ...
        return view('pages.dashboard-products-details', ['product' => $product, 'categories' => $categories]);
    }
    ...
    public function store(ProductRequest $request) {
        ...
        $gallery = ['products_id' => $product->id, 'photos' => $request->file('photos')->store('assets/product', 'public')];
